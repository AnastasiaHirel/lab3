...
public class MainFrame extends JFrame{
    ...
    public MainFrame(Double[] coefficients) {
        ...
        Action showInformationAction = new AbstractAction("О программе") {
            public void actionPerformed(ActionEvent event) {
                JOptionPane.showMessageDialog(MainFrame.this, "Гирель Анастасия, 6 группа", "О программе", JOptionPane.PLAIN_MESSAGE);
            }
        };
        showInformation = infoMenu.add(showInformationAction);
        ...
        buttonCalc.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent ev) {
                try {
                    ...
                    showInformation.setEnabled(true);
